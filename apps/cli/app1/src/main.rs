...
//     path::{Path, PathBuf},
// };
// use crate::command::CachixCaches;
// 
// // templates
...
// const SPECIAL_APP: &str = "nix";
// const SPECIAL_APP_STORE: &str = "nix-store";
// 
// #[derive(Parser)]
// #[command(
...
//             }
//             None => {
//                 self.run_nix(SPECIAL_APP, &["flake", "update"], &command::Options::default())?;
//             }
//         }
//         Ok(())
//     }
...
//                 .copied()
//                 .collect();
//             self.run_nix(SPECIAL_APP, &args, &command::Options::default())?;
//         }
// 
...
// 
//         // TODO: use --json
//         let metadata = self.run_nix(SPECIAL_APP, &["flake", "metadata"], &command::Options::default())?;
// 
...
//         }
// 
//         let env = self.run_nix(SPECIAL_APP, &args, &command::Options::default())?;
// 
//         let options = command::Options {
//             logging: false,
//             ..command::Options::default()
